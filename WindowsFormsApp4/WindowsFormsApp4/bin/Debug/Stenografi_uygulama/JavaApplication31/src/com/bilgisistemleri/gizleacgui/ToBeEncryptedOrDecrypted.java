...
public class ToBeEncryptedOrDecrypted extends javax.swing.JFrame
{
    ...
    public ToBeEncryptedOrDecrypted(File[] listOfFilesAndFolders, String encryptOrDecrypt)
    {
        ...
        if(encryptOrDecrypt.equalsIgnoreCase("encrypt"))
        {
            ...
            heading.setText("Şifrelenecek dosyaların / klasörlerin listesi:");
        }
        else if(encryptOrDecrypt.equalsIgnoreCase("decrypt"))
        {
            encryptOrDecryptButton.setText("DECRYPT");
            heading.setText("Şifresi çözülecek dosyaların / klasörlerin listesi:");
        }
        ...
        addWindowListener( new WindowAdapter()
        {
            public void windowClosing(WindowEvent e)
            {
                ...
                int result = JOptionPane.showConfirmDialog(frame, "Uygulamadan çıkmak istediğinizden emin misiniz?", "Çıkış", JOptionPane.YES_NO_OPTION);
    ...
    private void initComponents() {
        ...
        reSelectFilesButton.setText("Yeni dosya seç");
        ...
        addMoreFilesButton.setText("Dosya ekle");
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addComponent(heading, javax.swing.GroupLayout.PREFERRED_SIZE, 362, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(encryptOrDecryptButton, javax.swing.GroupLayout.PREFERRED_SIZE, 34, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(reSelectFilesButton, javax.swing.GroupLayout.Alignment.TRAILING))
                .addGap(22, 22, 22))
        );
