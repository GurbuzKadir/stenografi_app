        ...
        addWindowListener( new WindowAdapter()
        {
            public void windowClosing(WindowEvent e)
            {
                ...
                if(completedTask)
                {
                    ...
                    result = JOptionPane.showConfirmDialog(frame, "Çıkmak istediğinizden emin misiniz?", "Çıkış", JOptionPane.YES_NO_OPTION);
                ...
                {
                    Toolkit.getDefaultToolkit().beep();
                    result = JOptionPane.showConfirmDialog(frame, "Şifreleme sürüyor. "+"Çıkmak istediğinizden emin misiniz?", "Çıkış", JOptionPane.YES_NO_OPTION);
                    if (result == JOptionPane.YES_OPTION)
                    frame.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
                }
                ...
                {
                    Toolkit.getDefaultToolkit().beep();
                     result = JOptionPane.showConfirmDialog(frame, "Çözme sürüyor. "+"Çıkmak istediğinizden emin misiniz?", "Çıkış", JOptionPane.YES_NO_OPTION);
                     if (result == JOptionPane.YES_OPTION)
                     frame.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
                }
