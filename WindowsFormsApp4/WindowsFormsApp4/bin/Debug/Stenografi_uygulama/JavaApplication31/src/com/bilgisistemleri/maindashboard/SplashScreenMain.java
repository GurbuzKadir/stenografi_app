...
public class SplashScreenMain {
  ...
  public SplashScreenMain() {
    ...
    for (int i = 0; i <= 500; i++)
    {
      ...
      screen.setProgress("Çalışıyor " + i, i);  // progress bar with a message
      //screen.setProgress(i);           // progress bar with no message
    }
    splashScreenDestruct(); 
    JFrame frame = new JFrame("VİDEO STENOGRAFİ");
  ...
  private void splashScreenInit() {
    ImageIcon myImage = new ImageIcon(com.bilgisistemleri.maindashboard.SplashScreenMain.class.getResource("/resources/splash.png"));
