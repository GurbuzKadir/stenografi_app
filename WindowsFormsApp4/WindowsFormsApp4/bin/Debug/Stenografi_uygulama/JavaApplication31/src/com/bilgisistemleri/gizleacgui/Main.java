...
{   
    public Main(final boolean usedTheApplication)
    {
        ...
        addWindowListener( new WindowAdapter()
        {
            public void windowClosing(WindowEvent e)
            {
                ...
                int result = JOptionPane.showConfirmDialog(frame, "Çıkmak istediğine emin misin?", "çıkış", JOptionPane.YES_NO_OPTION);
    ...
    private void initComponents() {
        ...
        jButton3.setText("Dosya Şifrele");
