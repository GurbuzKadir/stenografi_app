...
public class PasswordTakerForEncryption extends javax.swing.JFrame
{
    ...
    boolean verifyPasswords()
    {
        ...
        {
            eightCharInstructionLabel.setText("Güvenlik nedeniyle en az 8 karakterden oluşan bir şifre girmelisiniz");
        ...
        if(password1.length>7)
        {
            ...
            eightCharInstructionLabel.setText("iki şifre farklı!");
            eightCharInstructionLabel.setVisible(true);
        }
    ...
    private void initComponents() {
        ...
        eightCharInstructionLabel.setText("EN AZ 8 KARAKTER OLMALI");
